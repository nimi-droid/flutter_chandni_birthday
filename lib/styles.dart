...
const tsSemiBoldTextGrey15 =
    TextStyle(color: AppColors.textGrey5, fontSize: 15.0, fontWeight: FontWeight.w600);

const tsSemiBoldTextDarkGrey18 =
    TextStyle(color: AppColors.textPrimaryColor, fontSize: 18.0, fontWeight: FontWeight.w600);
