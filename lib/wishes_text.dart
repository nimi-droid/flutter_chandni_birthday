...
final List<Person> mlist = [
  (Person(
      name: 'Chotu',
      assetImagePath: 'assets/images/chotu.jpg',
      personalMessage:
          '   I always want you to be happy in life,because you look great whenever you smile.  ' +
              '     ' +
              '     ' +
  ...
  Person(
      name: 'Rajesh',
      assetImagePath: 'assets/images/rajesh.jpg',
      personalMessage:
          '  Hi Chandni, mereko pehle se hi pata hai is baar... ki aapko pehle se hi pata hoga ki aapka bday aane wala hai... haa haa haa haaa happy birthday ummmmmmm  '),
  Person(
      name: 'Pratiksha',
      assetImagePath: 'assets/images/mainPage1.jpg',
      personalMessage:
          '   Hi, Happy birthday Darling, Tere birthday ke bare me kya bolu , hamne to 15 days pahale hi shuru kr di thi taiyari chandni ka bdy aane wala he, hehe  ' +
  ...
  Person(
      name: 'Alpesh',
      assetImagePath: 'assets/images/alpesh.jpg',
      personalMessage: '   Dear Hmm,  ' +
          ...
          '     ' +
          '  Thanks '
              'for being such a wonderful person. Love you Dfrr 😘 🤗  '),
  Person(
      name: 'Shivani',
      assetImagePath: 'assets/images/shivani.jpg',
      personalMessage: '   Hey Chandrika !!!  ' +
          '   Opppsss Chandni 🌛💓  ' +
          ...
          '     ' +
          '  We '
              'will celebrate your birthday after returing to office.. Take care  '),
  Person(
      name: 'Aditya',
      assetImagePath: 'assets/images/adityaBhai.jpg',
      personalMessage:
          '   You supported me when I needed it. You guided me when I was lost. You motivated me when I was doubtful. You are a true inspiration for me throughout my life. I am proud to have a sister like you. I wish you a very happy birthday, and God bless you with everything you want to achieve in this life.Thank you for giving me a shoulder to weep on, when I was sad, Thank you for making me feel special every time by your smile. You mean a lot to me, my dear sister.  I like the way you care. I like the way you read my thoughts. I never had to explain anything because you always understood my feelings better than me. You are not just my sister but a friend, guide and atrue inspiration for me. I wish you a wonderful birthday and let all your dreams come true.  ' +
              '   Once again,  ' +
              '  '
                  'HAPPY BIRTHDAY SANTO BHUA❤️❤️  '),
  Person(
      name: 'Harshit',
      assetImagePath: 'assets/images/Harshit.jpg',
      personalMessage: 'Happy '
          'Birthday to one of the few people whose birthday I can remember without a Facebook reminder.'),
  (Person(
      name: 'Piyush',
      assetImagePath: "assets/images/piyush.jpg",
      personalMessage:
          '12 years of friendship. Just wanted to remind you that you are very lucky to have a '
          'friend like me for so many years🤣.  Sometimes we talk so much for months and sometimes we dont even say hii for months.  It really doesnt matter if we talk or not the thing that really matters is you are my friend and you will  always be one.  I love the way you laugh and the way you talk with your heart and saying anything without thinking twice.  Sometimes its weird. But i admire it.  I am looking forward to many more years of friendship with you. In good times and bad i will always be by your side.  Hope your bday is as special as you are. HAPPY BIRTHDAY.  ')),
  Person(
      name: 'Gaurav',
      assetImagePath: 'assets/images/gaurav.jpg',
      personalMessage: '   Dear Chando,  ' +
          '   Hope ur birthday is spacial as you are.I celebrate you today because you deserve every bit of it and more😊.  ' +
          '  We have'
              ' been friends longer than I care to admit.you\'ve always been a source of joy to everyone around you.thanks for being such a wonderfull, irritating and caring person😝😝.ur smile is terrible. Kp smiling..✌🏼 gd day and happy birthday 🥂  '),
  Person(
      name: 'Nishu',
      assetImagePath: 'assets/images/nishu.jpg',
      personalMessage: '   My dear best friend,  ' +
          '     ' +
          '   Here\'s'
              ' your birthday today so obviously it would be a special day, not just for you even for me because this is the day when my bestie came into this world...🤩🥰❣️  ' +
          '   I am so happy today because finally after so long we are together on your birthday so let'
              '\'s celebrate our past, our future and our present which we have missed....🥳 I pray to god that you will get everything you want in life because you deserve the best😎😌  ' +
  ...
  Person(
      name: 'Nilesh',
      assetImagePath: 'assets/images/nilesh.jpg',
      personalMessage: '   Hi Dola  ' +
          '   You'
              ''
              '\'re an amazing person—never forget that! You deserve the best on your birthday.How can I forget a birthday we celebrated for so many years? Things may have changed between us, but my feelings of affection toward you haven\'t.  ' +
          '   As I close my eyes to bring back all the lovely memories of the times we\'ve shared '
              'together, a smile comes to my face. May you see wonderful and joyous times ahead. Here\'s '
              'wishing you a very happy birthday!  ' +
          '  Love you☺️  '),
  Person(
      name: 'Gaurav Delhi',
      assetImagePath: 'assets/images/GauravDelhi.jpg',
      personalMessage:
          '  I feel so lucky to have you as my friend. Hope your birthday is as special as you are. May all of your dreams come true. Thanks for being such a great friend. Happy birthday Moonlight !💐💐💐🎂🎂🎂🎂🎂🎂🎂🎂  '),
  Person(
      name: 'Divyanshu',
      assetImagePath: 'assets/images/divyanshu.jpg',
      personalMessage:
  ...
  Person(
      name: 'Devesh',
      assetImagePath: 'assets/images/devesh.jpg',
      personalMessage: '   Hey !!  ' +
          '     ' +
          '   The charming, the sparkling, the jaunty, the frenzied, and the captivating.  ' +
          '     ' +
          '   I '
              'recall that explosive laughter\'s, prolonged chit-chats, slightest studies, and that bold attitude whenever I think of you.  ' +
          '     ' +
          '   Your enthusiasm, positivity, courage and  confidence defines you perfectly. I\'m happy '
              'to express that we share an awesome bonding and gentle friendship in the minimal time we manage to meet.  ' +
          '     ' +
          ...
          '     ' +
          '   I miss good old days, I miss you, bitto, Rajat, Nishu & infact all the amazing time we '
              'had during school, those smallest and the sweetest memory lies with me all the times wherever I go. Hope you have a great birthday, thanks for making me recall all the pleasant hours. Let\'s meet sometime at different page of life. Wishing you plenty of goodness girl !!!! ☺️  ' +
          '     ' +
          '   Happy birthday 🎂🎂  ' +
          '     ' +
          '  Jiyo Chandu Baba. 💓  '),
  Person(
      name: 'Shivani Didi',
      assetImagePath: 'assets/images/shivaniDidi.jpg',
      personalMessage: '   My dear चंद्रकांता,  ' +
          '     ' +
  ...
  Person(
      name: 'Shubham',
      assetImagePath: 'assets/images/shubham.jpg',
      personalMessage:
          '   `Wish you many many happy returns of the day Chandini 🌙 Hope your special day,brings you all that your heart desires  ' +
              '  Happy Birthday 🍰 🍻  '),
  Person(
      name: 'Nishant',
      assetImagePath: 'assets/images/nishant.jpg',
      personalMessage:
  ...
  Person(
      name: 'Kamal',
      assetImagePath: 'assets/images/kamal.jpg',
      personalMessage: '   Dear CSD,  ' +
  ...
  Person(
      name: 'Vikrant',
      assetImagePath: 'assets/images/vikrant.jpg',
      personalMessage: '   Happy Birthday CSD, 🥳Theek hai! 🥳  ' +
          '     ' +
  ...
  Person(
      name: 'Vishaaal',
      assetImagePath: 'assets/images/vishal.jpg',
      personalMessage: '  Hi '
          'Chandni, wishing you laughter and happiness and a year that brings you much success. Here\'s to more adventures, like narkanda hike and _pausing_ on sofas, ahead. Party hard. Enjoy 🙂  '),
];
